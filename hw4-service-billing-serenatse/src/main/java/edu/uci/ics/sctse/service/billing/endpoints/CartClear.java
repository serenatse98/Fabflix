...
import edu.uci.ics.sctse.service.billing.models.CartClearRequestModel;
...
//                    {
//                        ServiceLogger.LOGGER.info("Email is not in carts.");
//                        resultCode = 312;
//                    }
//                    else
//                    {
                    ServiceLogger.LOGGER.info("Email in DB... clearing items...");
                    CartDatabase.clearFromCartDB(requestModel.getEmail());
                    resultCode = 3140;
//                    }
                }
