package edu.uci.ics.sctse.frontend;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.sctse.frontend.configs.Configs;
import edu.uci.ics.sctse.frontend.logger.ServiceLogger;
import edu.uci.ics.sctse.frontend.models.ConfigsModel;
...
public class FrontEnd {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.sctse.frontend.resources");
